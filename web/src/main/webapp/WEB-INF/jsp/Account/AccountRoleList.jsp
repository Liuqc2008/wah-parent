...
<body>
	...
	layui.use(['layer', 'element', 'form', 'table', 'laydate'], function(){
		...
		var table = layui.table,
  		...
  		table.render({
	    	elem: '#test',
	    	url:'/web/Common/AccountRoleList',
	    	cols: [[
				//{type: 'numbers' },
				{checkbox: true, fixed: 'left'},
                {field:'right', title: '操作', width: 130, toolbar: "#barDemo", align: 'center' },
	      		{field:'id', title: 'Id', width:80,  align: 'center', sort: true},
	      		{field:'name', title: '用户名', width:130, align: 'center'},
	      		{field:'password', title: '密码', width:130, align: 'center'},
	      		{field:'rolename', title: '角色', width:130, align: 'center'},
	      		{field:'createDate', title: '时间', width:180, align: 'center'},
	    	]],
	    	id: 'testReload',
	    	page: true,
	    	height: 'full-200',
