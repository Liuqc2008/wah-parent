...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name="post" action="/MavenSSM/Payment/AliPagePay" method="post" target="_blank">
		...
		<form name=tradequery action="/MavenSSM/Payment/AliPagePayQuery" method=post target="_blank">
			<div id="body2" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTQout_trade_no" name="out_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
						<input id="WIDTQtrade_no" name="trade_no" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
		...
		<form id="traderefund" name=traderefund action=alipay.trade.refund.jsp method=post target="_blank">
			<div id="body3" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTRout_trade_no" name="out_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<input class="new-btn-login" style="text-align: center;" type="button" value="退款" onClick="doRefund()"/>
						</span> 
		...
		<form name=traderefundquery action=/MavenSSM/Payment/AliPagePayRefundQuery method=post target="_blank">
			<div id="body4" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDRQout_trade_no" name="out_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
						<input id="WIDRQtrade_no" name="trade_no" />
					</dd>
					<hr class="one_line">
					<dt>退款请求号 ：</dt>
					<dd>
						<input id="WIDRQout_request_no" name="out_request_no" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
		...
		<form name=tradeclose action="/MavenSSM/Payment/AliPagePayClose" method=post target="_blank">
			<div id="body5" class="tab-content" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDTCout_trade_no" name="out_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>支付宝交易号 ：</dt>
					<dd>
						<input id="WIDTCtrade_no" name="trade_no" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
...
<script language="javascript">
	...
	function doRefund(){
		...
		$.Ajax("/MavenSSM/Payment/AliPagePayRefund", $("#traderefund").serializeArray(), function (result) {
		    alert("退款成功！");
		});
	}
