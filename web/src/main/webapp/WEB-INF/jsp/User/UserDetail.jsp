	...
	<div class="layui-form">
		<div class="layui-form-item ">
	        ...
	        <div class="layui-input-inline">
	            <input type="text" id="Name" Value="${user.name}" lay-verify="required|length" param="1,3" lay-verType="tips" autocomplete="off" class="layui-input">
	        </div>
	    </div>
	    <div class="layui-form-item ">
	        <label class="layui-form-label">密码：</label>
	        <div class="layui-input-inline">
	            <input type="text" id="Password" Value="${user.password}" lay-verify="required" lay-verType="tips" autocomplete="off" class="layui-input">
	        </div>
	    </div>
	    <div class="layui-form-item">
	...
	<script>
		...
		layui.use(['form', 'layedit'], function(){
	        ...
	        form.on('submit(Submit)', function (data) {
	        	...
	        	var url = id == 0 ? "/web/User/Add" :"/web/User/Update";
