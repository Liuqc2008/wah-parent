        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.confirm('确定删除该行？', function (index) {
                    $.Ajax("/MavenSSM/Role/Delete?id=" + data.id, {}, function (result) {
                        layer.alert("删除成功！");
                        Reload();
                        layer.close(index);
                    });
            	...
            	OpenFrame("修改角色信息", "/MavenSSM/Role/RoleDetail?id=" + data.id, 460, 250, '', Reload);
            }
        });
  		...
  		var $ = layui.$, active = {
			...
			Add: function () {
	         	OpenFrame("新增角色", "/MavenSSM/Role/RoleDetail", 460, 250, '', Reload);
	        },	
  			reload: function(){
